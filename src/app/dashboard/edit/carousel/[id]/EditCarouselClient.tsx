...
export default function EditCarouselClient({ announcement }: EditCarouselClientProps) {
  ...
  useEffect(() => {
    ...
    const formData: AnnouncementFormData = {
      ...
      carouselItems: announcement.content.items.map((item: any) => ({
        ...item,
      ...
      fontFamily: announcement.font_family || 'Work Sans',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!formData || !formData.carouselItems[0]?.message?.trim()) return
        ...
        <div className="space-y-6">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Rotation Speed: {formData.typeSettings.carousel_speed / 1000}s
                  </label>
                  <input
                    type="range"
                    min="2000"
                    max="10000"
                    step="500"
                    value={formData.typeSettings.carousel_speed}
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex justify-center pt-2">
              <button
                type="submit"
                disabled={loading || !formData.carouselItems[0]?.message?.trim()}
